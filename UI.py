...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(331, 260))
        MainWindow.setMaximumSize(QtCore.QSize(331, 260))
        MainWindow.setBaseSize(QtCore.QSize(331, 260))
        ...
        self.MainTab.setGeometry(QtCore.QRect(0, 0, 331, 215))
        ...
        self.Encode_Container_Label.setGeometry(QtCore.QRect(10, 10, 325, 20))
        ...
        self.Encode_InputFile_Label.setGeometry(QtCore.QRect(10, 65, 325, 20))
        ...
        self.Encode_Password_Label.setGeometry(QtCore.QRect(10, 120, 325, 20))
        ...
        self.Decode_Container_Label.setGeometry(QtCore.QRect(10, 10, 325, 20))
        ...
        self.Decode_Password_Label.setGeometry(QtCore.QRect(10, 65, 325, 20))
        ...
        self.About_Developer_Label = QtWidgets.QLabel(self.About)
        self.About_Developer_Label.setGeometry(QtCore.QRect(10, 5, 241, 16))
        self.About_Developer_Label.setObjectName("About_Developer_Label")
        self.About_email_Label = QtWidgets.QLabel(self.About)
        self.About_email_Label.setGeometry(QtCore.QRect(10, 35, 241, 16))
        self.About_email_Label.setOpenExternalLinks(False)
        self.About_email_Label.setObjectName("About_email_Label")
        self.About_VK_Label = QtWidgets.QLabel(self.About)
        self.About_VK_Label.setGeometry(QtCore.QRect(10, 65, 241, 16))
        self.About_VK_Label.setObjectName("About_VK_Label")
        self.About_Version_Label = QtWidgets.QLabel(self.About)
        self.About_Version_Label.setGeometry(QtCore.QRect(0, 160, 320, 20))
        self.About_Version_Label.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.MainTab.addTab(self.About, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.About_Developer_Label.setText(_translate("MainWindow", "Developer: Vladislav Lisyanskiy"))
        self.About_email_Label.setText(_translate("MainWindow", "e-mail: vladislav.lisyanskiy@gmail.com"))
        self.About_VK_Label.setText(_translate("MainWindow", "VK: vk.com/vladislav.lisyanskiy"))
        self.About_Version_Label.setText(_translate("MainWindow", "v1.02"))
        self.MainTab.setTabText(self.MainTab.indexOf(self.About), _translate("MainWindow", "About"))
